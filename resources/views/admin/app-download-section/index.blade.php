...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Sección de descarga de aplicaciones</h1>
        </div>

        <div class="card card-primary">
            <div class="card-header">
                <h4>Sección de actualización</h4>
            ...
            <div class="card-body">
                <form action="{{ route('admin.app-download.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div id="image-preview-2" class="image-preview image-preview-2">
                                    <label for="image-upload" id="image-label-2">Elija el archivo</label>
                    ...
                    <div class="form-group">
                        <label for="">Play Store URL <code>(Leave empty for hide)</code></label>
                        <input type="text" class="form-control" name="play_store_link" value="{{ @$appSection->play_store_link }}">
                    </div>

                    <div class="form-group">
                        <label for="">Apple Store URL <code>(Leave empty for hide)</code></label>
