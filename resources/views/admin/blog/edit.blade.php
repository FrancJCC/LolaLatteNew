        ...
        <div class="card-body">
            <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="seo_title" class="fsorm-control" value="{{ $blog->seo_title }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control" id="">
                        <option @selected($blog->status === 1) value="1">Activo</option>
                        <option @selected($blog->status === 0) value="0">Inactivo</option>
                    </select>
                </div>
