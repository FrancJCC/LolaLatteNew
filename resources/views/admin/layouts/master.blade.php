...
<head>
    ...
    <title>{{ config('settings.site_name') }} | Escritorio</title>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; {{ date('Y') }} <div class="bullet"></div> Desarrollado por <a href="https://websolutionus.com">Websolutionus</a>
                </div>
