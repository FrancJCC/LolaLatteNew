...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">Escirotio</a></div>
            <div class="breadcrumb-item"><a href="#">Componentes</a></div>
            <div class="breadcrumb-item">Ventana de chat</div>
        </div>
    </div>
