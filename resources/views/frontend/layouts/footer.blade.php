            ...
            <div class="row justify-content-between">
                <div class="col-lg-4 col-sm-8 col-md-6">
                    <div class="fp__footer_content">
                        <a class="footer_logo" href="/LolaLatteNew/public/">
                            <img src="{{ asset(config('settings.footer_logo')) }}" alt="LolaLatte" class="img-fluid w-100">
                        </a>
                ...
                <div class="col-lg-3 col-sm-8 col-md-6 order-lg-4">
                    <div class="fp__footer_content">
                        ...
                        <form class="subscribe_form">
                            ...
                            <button type="submit" class="subscribe_btn">Seguir</button>
                        </form>
