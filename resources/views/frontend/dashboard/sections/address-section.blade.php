<div class="tab-pane fade" id="v-pills-address" role="tabpanel" aria-labelledby="v-pills-address-tab">
    <div class="fp_dashboard_body address_body">
        <h3>Dirección  <a class="dash_add_new_address"><i class="far fa-plus"></i> agregar Nuevo
            </a>
        </h3>
                ...
                <form action="{{ route('address.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            <div class="fp__check_single_form">
                                <select id="select_js3" name="area">
                                    <option value="">Sleleccionar Area</option>
                        ...
                        <div class="col-12">
                            ...
                            <button type="submit" class="common_btn">Guardar Dirección</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="fp_dashboard_edit_address edit_section_{{ $address->id }}" >
                <form action="{{ route('address.update', $address->id) }}" method="Post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <button type="button" class="common_btn cancel_edit_address">cancelar</button>
                            <button type="submit" class="common_btn">Guardar
                                Dirección</button>
                        </div>
                    </div>
                </form>
